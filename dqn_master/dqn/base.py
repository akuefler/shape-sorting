...
class BaseModel(object):
  ...
  def load_model(self):
    ...
    #self.checkpoint_dir= 'checkpoints/shapesort/july9/'
    #load_dir= 'checkpoints/shapesort/july9/'
    ...
    if ckpt and ckpt.model_checkpoint_path:
      ...
      fname = os.path.join(load_dir, ckpt_name)
  ...
  def model_dir(self):
    ...
    model_dir += '/' + self.config.folder_name
    return model_dir + '/'
