...
class Environment(object):
  def __init__(self, config):
    if config.env_name == 'ShapeSorter':
      #self.env = ShapeSorter(**SHAPESORT_ARGS[config.game_settings])
...
class ShapeSorterEnvironment(ShapeSorter):
  def __init__(self, config, game_settings):
    super(ShapeSorterEnvironment, self).__init__(**game_settings)
